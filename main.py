...
from slm.networks import Embedding, Transformer  # Import the Embedding class
import torch
...
transform = Transformer(vocab_size=len(bow.word_to_index), embedding_dim=5)  # Create an instance of the Transformer class
